...
(function ($) {
    ...
    $.ias = function (options) {
        ...
        function paginate(curScrOffset, onCompleteHandler) {
            ...
            urlNextPage = $(opts.pagination).data('next');
            if (!urlNextPage) {
                if (opts.noneleft) {
            ...
            loadItems(urlNextPage, function (data, items) {
                ...
                urlNextPage = $(opts.pagination, data).data('next');
    ...
    $.ias.defaults = {
        ...
        next: '.next',
        noneleft: false,
        loader: '<a class="ias_loader">Зарузка</a>',
        loaderDelay: 600,
        triggerPageThreshold: 1,
        trigger: '<a class="ias_trigger">Загрузить ещё</a>',
        thresholdMargin: 0,
        history: true,
